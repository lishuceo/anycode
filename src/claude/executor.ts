...
- 当用户提供了 GitHub/GitLab 等远程仓库 URL，需要 clone 代码时
- 当用户指定了本地仓库路径，需要在隔离环境中操作时
- 当用户的请求涉及某个仓库，且当前工作目录不是该仓库时
...
export class ClaudeExecutor {
   ...
   * @param options     可选参数 (maxTurns, maxBudgetUsd, disableWorkspaceTool)
   */
  async execute(
    sessionKey: string,
    prompt: string,
