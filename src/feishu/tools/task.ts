...
export function feishuTaskTool(getUserToken?: () => Promise<string | undefined>, requesterId?: string) {
  return tool(
    ...
    [
      ...
      '',
      '⚠️ 创建任务时必须归入以下 4 个清单之一，根据任务内容选择最合适的清单，不确定时默认用 Bot:',
      '  - Bot (默认): c7f1907f-4d80-430f-837d-94ce300d2efc',
      '  - MCPTools: 57614ca5-c704-436a-820e-7b5b361d43de',
      '  - UrhoX: 1e358420-cba4-4054-9b83-d3ac24bd84bd',
      '  - Maker: f3d4c103-b2d7-4154-9f25-9a72e12a4bf3',
      '  示例: tasklists=\'[{"tasklist_guid": "c7f1907f-4d80-430f-837d-94ce300d2efc"}]\'',
      '',
